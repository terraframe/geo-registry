...
@com.runwaysdk.business.ClassSignature(hash = 1578767694)
/**
 ...
 */
public  class CreateGeoObjectActionQuery extends net.geoprism.registry.action.geoobject.GeoObjectActionQuery

{
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getComponentQuery().get(net.geoprism.registry.action.geoobject.CreateGeoObjectAction.HIERARCHYCODE, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getHierarchyCode(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getComponentQuery().get(net.geoprism.registry.action.geoobject.CreateGeoObjectAction.HIERARCHYCODE, alias, displayLabel);

  }
  public com.runwaysdk.query.SelectableChar getHierarchyJson()
  {
    return getHierarchyJson(null);

  }
 
  public com.runwaysdk.query.SelectableChar getHierarchyJson(String alias)
  {
    return (com.runwaysdk.query.SelectableChar)this.getComponentQuery().get(net.geoprism.registry.action.geoobject.CreateGeoObjectAction.HIERARCHYJSON, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getHierarchyJson(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getComponentQuery().get(net.geoprism.registry.action.geoobject.CreateGeoObjectAction.HIERARCHYJSON, alias, displayLabel);
 ...
 **/
  public interface CreateGeoObjectActionQueryReferenceIF extends net.geoprism.registry.action.geoobject.GeoObjectActionQuery.GeoObjectActionQueryReferenceIF
  {
 ...
 * This type is used when a join is performed on this class as a reference.
 **/
  public static class CreateGeoObjectActionQueryReference extends net.geoprism.registry.action.geoobject.GeoObjectActionQuery.GeoObjectActionQueryReference
 implements CreateGeoObjectActionQueryReferenceIF
  ...
  public com.runwaysdk.query.SelectableChar getHierarchyCode(String alias)
  {
    return (com.runwaysdk.query.SelectableChar)this.get(net.geoprism.registry.action.geoobject.CreateGeoObjectAction.HIERARCHYCODE, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getHierarchyCode(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.get(net.geoprism.registry.action.geoobject.CreateGeoObjectAction.HIERARCHYCODE, alias, displayLabel);
  ...
  public com.runwaysdk.query.SelectableChar getHierarchyJson(String alias)
  {
    return (com.runwaysdk.query.SelectableChar)this.get(net.geoprism.registry.action.geoobject.CreateGeoObjectAction.HIERARCHYJSON, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getHierarchyJson(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.get(net.geoprism.registry.action.geoobject.CreateGeoObjectAction.HIERARCHYJSON, alias, displayLabel);
 ...
 * This type is used when a join is performed on this class as a reference.
 **/
  public interface CreateGeoObjectActionQueryMultiReferenceIF extends net.geoprism.registry.action.geoobject.GeoObjectActionQuery.GeoObjectActionQueryMultiReferenceIF
  {
 ...
 * This type is used when a join is performed on this class as a reference.
 **/
  public static class CreateGeoObjectActionQueryMultiReference extends net.geoprism.registry.action.geoobject.GeoObjectActionQuery.GeoObjectActionQueryMultiReference
